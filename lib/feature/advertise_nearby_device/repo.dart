...
class BleRepo {
  ...
  void initialize() {
    ///
    availabilityStreamController =
        StreamController<AvailabilityState>.broadcast();
    availabilityStream = availabilityStreamController.stream;
    sub = UniversalBle.availabilityStream.listen(
      availabilityStreamController.add,
    );
  ...
  void dispose() {
    sub.cancel();
    availabilityStreamController.close();
  }
